...
describe "Admin Invoices Index Page" do
  before :each do
    ...
    @coupon1 = Coupon.create!(name: "Summer Savings", code: "ABOI34", amount_off: 25, coupon_type: "percent_off", active: true, merchant: @m1)
    @coupon2 = Coupon.create!(name: "First Time Buyer", code: "JKHFD23", amount_off: 5, coupon_type: "amount_off", active: true, merchant: @m1)

    @i1 = Invoice.create!(customer_id: @c1.id, status: 2, created_at: "2012-03-25 09:54:09")
    @i2 = Invoice.create!(customer_id: @c2.id, status: 2, created_at: "2012-03-25 09:30:09")
    @i3 = Invoice.create!(customer_id: @c1.id, status: 2, created_at: "2012-03-26 10:00:00", coupon_id: @coupon1.id)

    @item_1 = Item.create!(name: "test", description: "lalala", unit_price: 6, merchant_id: @m1.id)
    @item_2 = Item.create!(name: "rest", description: "dont test me", unit_price: 12, merchant_id: @m1.id)
    @item_3 = Item.create!(name: "best", description: "cha cha cha", unit_price: 15, merchant_id: @m1.id)

    @ii_1 = InvoiceItem.create!(invoice_id: @i1.id, item_id: @item_1.id, quantity: 12, unit_price: 2, status: 0)
    @ii_2 = InvoiceItem.create!(invoice_id: @i1.id, item_id: @item_2.id, quantity: 6, unit_price: 1, status: 1)
    @ii_3 = InvoiceItem.create!(invoice_id: @i3.id, item_id: @item_2.id, quantity: 10, unit_price: 10, status: 2)
  ...
  it "should display the total revenue the invoice will generate" do
    ...
    expect(page).to_not have_content(@i3.total_revenue)
  end
