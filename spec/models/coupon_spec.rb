...
RSpec.describe Coupon, type: :model do
  ...
  describe "class methods" do
    before :each do
      ...
      @coupon2 = Coupon.create!(name: "First Time Buyer", code: "JKHFD23", amount_off: 5, coupon_type: "amount_off", active: false, merchant: @merchant1)
      @coupon3 = Coupon.create!(name: "5 Off", code: "dfkng34789", amount_off: 5, coupon_type: "percent_off", active: true, merchant: @merchant2)
      @coupon4 = Coupon.create!(name: "Happy Summer", code: "as356", amount_off: 5, coupon_type: "amount_off", active: true, merchant: @merchant1)
    ...
    it "usage_count" do
      expect(@coupon1.usage_count).to eq(3)
